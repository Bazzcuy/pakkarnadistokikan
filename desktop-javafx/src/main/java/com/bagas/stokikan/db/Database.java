...
public class Database {
    ...
    private static void seed(Connection c) throws SQLException {
        ...
        if (isEmpty(c, "produksi_giling")) {
            ...
            execute(c, "INSERT INTO produksi_giling(batch_no,tanggal,jenis_ikan_id,berat_mentah_kg,berat_hasil_kg,penyusutan_kg,biaya_produksi,harga_jual_per_kg,catatan) VALUES(?,?,?,?,?,?,?,?,?)", "BG-202606-006", "2026-06-24", 1, 26.0, 22.0, 4.0, 120000.0, 98000.0, "Produksi tenggiri jumlah besar");
