...
public class ReportService {
    public String dashboard() {
        ...
        return "DASHBOARD SISTEM STOK IKAN GILING\n\n" +
                "Total stok mentah : " + totalMentah + " kg\n" +
                "Total stok giling : " + totalGiling + " kg\n" +
                "Total nilai penjualan : Rp " + totalJual + "\n" +
                "Transaksi belum lunas : Rp " + piutang + "\n\n" +
